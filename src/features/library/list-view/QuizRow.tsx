  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mr-2.5 flex aspect-[5/7] h-8 shrink-0 items-center justify-center overflow-hidden rounded-sm bg-gradient-to-br from-amber-400/20 to-accent-purple/20 sm:h-9">
          <ListChecks size={14} className="text-amber-400/80" />
        </div>
        ...
        <span className="mr-2 hidden items-center gap-1 rounded bg-amber-400/20 px-1.5 py-0.5 text-[10px] font-semibold text-amber-400 sm:inline-flex">
          <ListChecks size={9} />
