 ...
 * active workspace name ("Personal" or the org name) that opens the
 * shared OrgSwitcherPopover anchored to itself. The popover injects
 * ref / onClick / aria props into the trigger button.
 */
