            ...
            <>
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-glass-border bg-bg-secondary/50 px-3 py-2 text-sm text-text-primary outline-none focus:border-accent-purple"
                >
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={200}
                  className="w-full rounded-lg border border-glass-border bg-bg-secondary/50 px-3 py-2 text-sm text-text-primary placeholder:text-text-muted outline-none focus:border-accent-purple"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full resize-y rounded-lg border border-glass-border bg-bg-secondary/50 px-3 py-2 text-sm text-text-primary placeholder:text-text-muted outline-none focus:border-accent-purple"
                />
              </div>
