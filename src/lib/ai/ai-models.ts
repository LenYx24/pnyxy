...
export const AI_MODEL_CATALOG: ModelInfo[] = [
  {
    ...
    modelId: "auto",
    description:
      "Pnyxy ingyenes szerveres útvonala. Sima chat-kérésekhez a legolcsóbb működő szolgáltatóhoz fut át (Gemini 3.5 Flash-Lite → Gemini 3.6 Flash → GPT-4o-mini → Gemini 3.7 Flash fallback sorrendben), tool-use műveleteknél (kvíz/roadmap-generálás, könyvtár rendezése) ugyanezt a láncot járja be function callinggal, Claude Haiku 4.5 a végső fallback. A chat composer modell-választójában explicit pinelhető a Gemini 3.7 Flash is, ez a Google legújabb chat-modellje (ugyanaz amit a gemini.google.com webapp ad), kicsit drágább per token mint a 2.5 Flash, de új-generációs minőség. Nem kell saját API-kulcs, viszont napi kvóta korlátozza.",
    bestFor: [
